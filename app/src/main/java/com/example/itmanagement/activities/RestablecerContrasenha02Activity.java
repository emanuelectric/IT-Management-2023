...
public class RestablecerContrasenha02Activity extends AppCompatActivity {
    ...
    private void restablecerContrasenha() {
        ...
        if (!nuevaContrasenha.isEmpty() && !confirmarNuevaContrasenha.isEmpty()) {
            ...
            if (nuevaContrasenha.equals(confirmarNuevaContrasenha)) {
                ...
                // Después de restablecer la contraseña con éxito, llamar a LanzarVistaIniciarSesion
                LanzarVistaIniciarSesion();
            } else {
    ...
    // Método para lanzar la vista de inicio de sesión
    private void LanzarVistaIniciarSesion() {
