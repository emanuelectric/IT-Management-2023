...
public class MenuPrincipalClienteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_principal_cliente_layout);
    ...
    public void CerrarSesion(View view) {
        ...
        builder.setPositiveButton("Sí", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(MenuPrincipalClienteActivity.this, MenuInicialActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_desplegable_cliente_layout, menu);
        return true;
    }
